package com.simenko.qmapp.presentation.ui.main.products.kinds.set.stages.forms
...
@Composable
fun ComponentStageKindForm(
    modifier: Modifier = Modifier,
    viewModel: ComponentStageKindViewModel,
    route: Route.Main.ProductLines.ProductKinds.ProductSpecification.AddEditComponentStageKind
) {
    ...
    Column(
        ...
        Column(
            ...
            InfoLine(modifier = modifier.padding(start = Constants.DEFAULT_SPACE.dp), title = "Product", body = componentStageKind.componentKind.productKind.productKind.productKindDesignation)
            InfoLine(modifier = modifier.padding(start = Constants.DEFAULT_SPACE.dp), title = "Component", body = componentStageKind.componentKind.componentKind.componentKindDescription)
            Spacer(modifier = Modifier.height(10.dp))
            RecordFieldItem(
            ...
            RecordFieldItem(
                modifier = Modifier.width(320.dp),
                valueParam = Triple(componentStageKind.componentStageKind.componentStageDescription, fillInErrors.componentStageKindDescriptionError) { viewModel.onSetComponentKindDescription(it) },
