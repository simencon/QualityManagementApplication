package com.simenko.qmapp.presentation.ui.main.structure.forms.channel
    ...
    Column(horizontalAlignment = Alignment.Start, verticalArrangement = Arrangement.Bottom) {
        ...
        InfoLine(
            modifier = modifier
                ...
                .fillMaxWidth(),
            title = "Department",
            body = concatTwoStrings(cnComplete.subDepartmentWithParents.depAbbr, cnComplete.subDepartmentWithParents.depName)
        )
        InfoLine(
            modifier = modifier
                .padding(start = DEFAULT_SPACE.dp)
