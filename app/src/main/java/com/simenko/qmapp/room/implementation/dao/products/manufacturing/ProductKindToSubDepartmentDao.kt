...
import com.simenko.qmapp.room.entities.products.DatabaseProductKindToSubDepartment
...
abstract class ProductKindToSubDepartmentDao: DaoBaseModel<ID, ID, DatabaseProductKindToSubDepartment> {
    ...
    abstract fun getRecordsByParentId(parentId: ID): List<DatabaseProductKindToSubDepartment>
